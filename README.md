...
- **F5 东方古典**　仕女、剪纸、复古杂志、仙侠、刺绣、绢本工笔、月份牌。默认竖图。
- **F6 氛围实验**　黑暗、符号、电影感。默认竖图。
- **F7 写实摄影**　纪实、胶片、早期手机快照、影棚、运动、器物禅意。比例按主题定。
...
交付前还有两道机器把关：一是矛盾扫描，「马长角」「水墨混油画」「又要特写又要全身」这类自相矛盾会被拦下来；二是风格库一致性检查，61 个变体的清单、状态、计数有没有对不上，脚本一键核对。
