...
| 用途 | Codex CLI `--size`（内置 image_gen 不暴露尺寸参数，用模型默认） | Grok `aspect_ratio` |
|------|---------------------------|---------------------|
| 人物 / 海报竖（默认） | `1536x2048` | `3:4` |
| 立轴 / F7-V 影棚 / F1-TX 踏雪寻仙 | `1024x1536` | `2:3` |
| 城市卡 C / 纸雕 / F3-LC 层叠城市 | `2048x1536` | `4:3` |
| 治愈 F4 方图 / F2-JS 金石方印 | `1536x1536` | `1:1` |
| 头图 / 封面横 / F2-3D 3D书法 | `2048x1152` | `16:9` |
...
**4:5 替代规则**：多数宿主（含 Grok）不提供 4:5——用 `3:4` 替代，同为竖幅、构图段无需改写；更修长用 `2:3`，方幅封面用 `1:1`。推荐比例前先对照本表宿主实际可用清单，不给宿主做不出来的比例。
